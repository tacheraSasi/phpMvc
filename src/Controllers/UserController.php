...
class UserController
{
    ...
    {
        return $response->json(['message' => 'Create form for usercontroller']);
    }
    ...
    public function show(Request $request, Response $response): Response
    {
        ...
        return $response->json([
            'message' => 'Showing usercontroller with ID: ' . $id,
            'data' => ['id' => $id]
        ]);
    }
    ...
    public function edit(Request $request, Response $response): Response
    {
        ...
        return $response->json(['message' => 'Edit form for usercontroller ID: ' . $id]);
    }
